...
const UpcomingTaskLarge = (props) =>
{
    ...
    return (
        <Row className="upcoming-task-large" onClick={() => { history.push('/courses/web/classwork') }} style={{ marginBottom: '17px', backgroundColor: background, borderRadius: '20px' }} align='middle' justify="center">
